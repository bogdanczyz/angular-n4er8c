...
export class WorkersComponent implements OnInit, OnDestroy {
  ...
  ChangeColor(dane)
  {
    ...
    // let tr = document.getElementById('tr'+ dane)
    // console.log(tr)
    // for(var i = 0;i<this.searchWorker.length;i++)
    // {
    //   let _tr = document.getElementById('tr'+ i)
    //   _tr.style.backgroundColor="rgba(0, 0, 0, 0)";
    // }
